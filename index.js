...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        ...
        card.innerHTML = `
            ...
            <p><strong>$${game.pledged.toLocaleString()}</strong> raised of $${game.goal.toLocaleString()}</p>
...
function filterUnfundedOnly() {
    ...
    console.log("filterUnfundedOnly ->", unfunded.length, "games");
...
function filterFundedOnly() {
    ...
    console.log("filterFundedOnly ->", funded.length, "games");
...
function showAllGames() {
    deleteChildElements(gamesContainer);
    console.log("showAllGames ->", GAMES_JSON.length, "games");
...
const runnerElement = document.createElement("h4");
